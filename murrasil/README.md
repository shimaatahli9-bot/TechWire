...
- إنشاء مقالات إخبارية احترافية بالذكاء الاصطناعي (Gemini 2.5 Flash مجاني)
...
5. عدّل ملف `.env` وأضف مفتاح Gemini API:
```
...
4. **الإعدادات**: اضغط على أيقونة الإعدادات لإدارة المصادر
...
- **نموذج AI**: Gemini 2.0 Flash (مجاني)
